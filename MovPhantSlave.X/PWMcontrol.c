...
// Configure PWM1, but do not start it. Also sets up PWM1 interrupts
 ...
 //   PG1EVTL = PG1EVTL | 8;
    ...
    IEC4bits.PWM1IE = 1; //Enable PWM1 interrupt      ********************DON'T FORGET TO RE-ENABLE THE INTERRUPT !!!!!!!!!!!!!!! ****************
...
//    //set period 
//  //  gs_maxPWMInteger = 12799;            // maximum PWM integer allowed
//    PG2PER = gs_maxPWMInteger; //PWM period is PG1PER+1 clock cycles. Value of 12799 is designed to give period of 12800 / 256 MHz = 50 micro-seconds
